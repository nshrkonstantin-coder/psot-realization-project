      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-white">Отчитаться по КБТ</h1>
          </div>
        </div>

        <Card className="bg-slate-800/50 border-blue-500/30 p-12">
          <div className="text-center">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-2xl shadow-lg inline-block mb-6">
...
export default KBTReportFormPage;
