...
export default function PabListPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Список ПАБ</h1>
          </div>
        ...
        <Card className="p-6 mb-6 sticky top-0 z-10 shadow-md">
          <div className="flex items-center gap-4">
            {filteredRecords.length > 0 && (
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-sm text-gray-600 dark:text-gray-300">Выбрать все</span>
              </div>
            )}
